...
Refresh.Web.ColorValuePicker.prototype = {
	initialize: function(ids) {
		...
		this._hueInput = $(ids.hue.input.id);
		this._valueInput = $(ids.bright.input.id);
		this._saturationInput = $(ids.sat.input.id);

		this._redInput = $(ids.red.input.id);
		this._greenInput = $(ids.green.input.id);
		this._blueInput = $(ids.blue.input.id);

		this._hexInput = $(ids.hex.id);
