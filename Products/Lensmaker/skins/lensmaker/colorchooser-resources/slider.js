...
Refresh.Web.Slider.prototype = {
	...
	initialize: function(id, settings) {
		...
		this.settings.parent.appendChild(this._arrow);
	...
	_setArrowPosition: function(offsetX, offsetY) {
		...
		var posX = offsetX;
		var posY = offsetY;
		//Need to add the offset from the table.
		var parent = Ext.get(this._bar).parent().parent().parent();
		var diffX = Ext.get(this._bar).getX() - parent.getX() + 9;
		var diffY = Ext.get(this._bar).getY() - parent.getY() + 2;
